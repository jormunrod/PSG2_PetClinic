                ...
                <%@ taglib prefix="petclinic" tagdir="/WEB-INF/tags" %>
                    <petclinic:layout pageName="owners">
                        ...
                        <table class="table table-striped">
                            ...
                            <tr>
                                <th id="addressColumn">Address</th>
                                <td>
                            ...
                            <tr>
                                <th id="telephoneColumn">Telephone</th>
                                <td>
                        ...
                        <table class="table table-striped">
                            <caption>Pets and Their Visits</caption>
                            <thead>
                                <tr>
                                    <th id="visitDateColumn">Visit Date</th>
                                    ...
                                    <tr>
                                        ...
                                        <td valign="top">
                                            <table class="table-condensed">
                                                <caption>Visits of ${pet.name}</caption>
                                                <thead>
                                                    <tr>
                                                        <th id="visitDateColumn">Visit Date</th>
                                                        <th id="descriptionColumn">Description</th>
                                                ...
                                                <tbody>
                                                    <c:forEach var="visit" items="${pet.visits}">
                                                        <tr>
                                                            <td>
                                                                <petclinic:localDate date="${visit.date}"
                                                                    pattern="yyyy-MM-dd" />
                                                            </td>
                                                            <td>
