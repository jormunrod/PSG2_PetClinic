...
function AppNavbar() {
    ...
    function formatPlan(plan) {
        ...
        return plan !== null ? plan.charAt(0).toUpperCase() + plan.slice(1).toLowerCase() : null;
    }
        ...
        if (role === "CLINIC_OWNER") {
            ownerLinks = (
                <>
                    ...
                    <NavItem>
                        <NavLink style={{ color: "white" }} tag={Link} to="/rooms">Rooms</NavLink>
                    </NavItem>
                    <NavItem>
                        <NavLink style={{ color: "white" }} tag={Link} to="/owners">Owners</NavLink>
                    </NavItem>
                    ...
                    <NavItem>
                        <NavLink style={{ color: "white" }} tag={Link} to="/customerAgreement">Customer Agreement</NavLink>
                    </NavItem>
                </>
            )
        }
    ...
    if (!jwt) {
        ...
        userLogout = (
            <>
                ...
                <NavItem className="d-flex">
                    <NavbarText style={{ color: formatPlan(plan) === "Platinum" ? "blue" : formatPlan(plan) === "Gold" ? "yellow" : "grey" }} className="justify-content-end">{formatPlan(plan)}</NavbarText>
                </NavItem>
                <NavItem className="d-flex">
